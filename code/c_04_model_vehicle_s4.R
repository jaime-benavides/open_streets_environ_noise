...
all_openstreets_all_cnstract_trad_vehicle_interv <- gamm4::gamm4(vehicle ~ s(perc_area, k=4, fx=TRUE) + intervened +  perc.pov + perc.black + perc.hisp +
...
saveRDS(all_openstreets_all_cnstract_trad_vehicle_interv, paste0(output.folder, "all_openstreets_all_cnstract_trad_vehicle_interv_perc_area_s4.rds"))