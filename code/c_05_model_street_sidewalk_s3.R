...
all_openstreets_all_cnstract_trad_street_sidewalk_interv <- gamm4::gamm4(street_sidewalk ~ s(perc_area, k=3, fx=TRUE) + intervened + perc.pov + perc.black + perc.hisp +
...
saveRDS(all_openstreets_all_cnstract_trad_street_sidewalk_interv, paste0(output.folder, "all_openstreets_all_cnstract_trad_street_sidewalk_interv_perc_area_s3.rds"))
