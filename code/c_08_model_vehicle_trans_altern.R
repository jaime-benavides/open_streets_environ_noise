...
implem_all_cnstract_trad_vehicle_interv <- gamm4::gamm4(vehicle ~ s(perc_area, k=5, fx=TRUE) + intervened + perc.pov + perc.black + perc.hisp +
...
saveRDS(implem_all_cnstract_trad_vehicle_interv, paste0(output.folder, "implem_all_cnstract_trad_vehicle_interv_perc_area_s5.rds"))
