# aim: street_sidewalk model from main analysis with 4 knots in area covered by open streets
...
saveRDS(all_openstreets_all_cnstract_trad_street_sidewalk_interv, paste0(output.folder, "all_openstreets_all_cnstract_trad_street_sidewalk_interv_perc_area_s4.rds"))
