# aim: street_sidewalk model from main analysis adding open restaurants as covariate
...
poi_nyc <- readRDS(paste0(generated.data.folder, "poi_nyc", ".rds"))
...
all_openstreets_all_cnstract_trad_street_sidewalk_interv_op_rest <- gamm4::gamm4(street_sidewalk ~ s(perc_area, k=5, fx=TRUE) + intervened + open_restaurants + perc.pov + perc.black 
...
saveRDS(all_openstreets_all_cnstract_trad_street_sidewalk_interv_op_rest, paste0(output.folder, "all_openstreets_all_cnstract_trad_street_sidewalk_interv_perc_area_s5_op_rest.rds"))
