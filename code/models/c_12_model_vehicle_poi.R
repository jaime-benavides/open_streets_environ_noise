...
all_openstreets_all_cnstract_trad_vehicle_interv_poi <- gamm4::gamm4(vehicle ~ s(perc_area, k=5, fx=TRUE) + intervened +  poi_nyc + perc.pov + perc.black + perc.hisp +
...
saveRDS(all_openstreets_all_cnstract_trad_vehicle_interv_poi, paste0(output.folder, "all_openstreets_all_cnstract_trad_vehicle_interv_perc_area_s5_poi.rds"))
