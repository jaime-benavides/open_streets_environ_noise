# aim: street_sidewalk model from main analysis adding POIs as covariate
...
all_openstreets_all_cnstract_trad_street_sidewalk_interv_poi <- gamm4::gamm4(street_sidewalk ~ s(perc_area, k=5, fx=TRUE) + intervened + poi_nyc + perc.pov + perc.black 
...
saveRDS(all_openstreets_all_cnstract_trad_street_sidewalk_interv_poi, paste0(output.folder, "all_openstreets_all_cnstract_trad_street_sidewalk_interv_perc_area_s5_poi.rds"))
