...
all_openstreets_all_cnstract_trad_vehicle_interv_op_rest <- gamm4::gamm4(vehicle ~ s(perc_area, k=5, fx=TRUE) + intervened +  open_restaurants + perc.pov + perc.black + perc.hisp +
...
saveRDS(all_openstreets_all_cnstract_trad_vehicle_interv_op_rest, paste0(output.folder, "all_openstreets_all_cnstract_trad_vehicle_interv_perc_area_s5_op_rest.rds"))
