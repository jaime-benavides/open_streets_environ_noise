...
# # read open streets according to Transportation Alternatives
...
# save intermediate file of open streets by transportation alternatives after geocoding addresses to coordinates
...
# # adding manually the lat long of non geocoded (by visual check and coordinates gathering using google maps)
open_streets_imp$Nearby.Address[which(is.na(open_streets_imp$lat))]
# # 18 missing locations 
# # some are left as na's because not sufficient data to geo-reference
...
# build spatial object for open streets from transportation alternatives
