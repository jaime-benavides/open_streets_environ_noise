# aim: collect estimated geometrical stats by street segment parameters 
...
# obtain the indexes of the street segments that were estimated in a_02_prepare_street_geometrical_data_2_out_5.R 
...
# there are some values that are not expected in reality (i.e. aspect ratio higher than 20), assign NA to those. real cities have a max of 10 of canyon aspect ratio H / W  (Oke, 2017)
