...
all_openstreets_all_cnstract_trad_vehicle_interv_sp <- gamm4::gamm4(vehicle ~ s(perc_area, k=5, fx=TRUE) + intervened +  t2(lat,lon) + perc.pov + perc.black + perc.hisp +
...
saveRDS(all_openstreets_all_cnstract_trad_vehicle_interv_sp, paste0(output.folder, "all_openstreets_all_cnstract_trad_vehicle_interv_perc_area_s5_sp.rds"))
